...
const StudentDetail = ({ route, navigation }) => {
  ...
  const uploadImage = async (uri) => {
    try {
      ...
      if (student && student.length > 0) {
        ...
        if (!uploaded) {
          console.error(
            "No se pudo subir la imagen con ninguna extensión válida."
          );
        }
      }
    } catch (error) {
  ...
  const ordenarCarrerasPorFecha = (carreras) => {
    return carreras.sort(
      (a, b) => new Date(a.fecha_matricula) - new Date(b.fecha_matricula)
    );
  };
              ...
              {student && student.length > 0 && (
                <>
                  ...
                  >
                    ...
                    <View style={styles.textInfo}>
                      <View style={styles.infoItem1}>
                        ...
                        <View>
                          ...
                          <Text style={styles.text}>
                            {capitalizeFirstLetter(student[0].nombre)}{" "}
                            {capitalizeFirstLetter(student[0].apellido)}
                          </Text>
                        </View>
                      </View>
                      ...
                      <View style={styles.infoItem1}>
                        ...
                        <View>
                          ...
                          <Text style={styles.text}>
                            {student[0].tipo_documento}{" "}
                            {student[0].numero_documento}
                          </Text>
                        </View>
                      </View>
                      ...
                      <View style={styles.infoItem1}>
                        ...
                        <View>
                          ...
                          <Text style={styles.text}>
                            {student[0].fecha_nacimiento
                              ? formatDate(student[0].fecha_nacimiento)
                              : "No disponible"}
                          </Text>
                        </View>
                      </View>
                    ...
                    {student.length > 1 &&
                      ordenarCarrerasPorFecha(student.slice(1)).map(
                        (carrera, index) => (
                            ...
                            {carrera.estado_academico === "Graduado" && (
                              <View style={styles.infoItem1}>
                                ...
                                <View>
                                  ...
                                  <Text style={styles.text}>
                                    {formatDate(carrera.fecha_graduacion)}
                                  </Text>
                                </View>
                              </View>
                            )}
